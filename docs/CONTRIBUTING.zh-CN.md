...
在 WORKGPT 里，品味意味着清晰的流程、克制的界面、自然的文案，以及用一次就能理解的行为。好的贡献不只是把功能做出来，也要体现判断力。
...
一个结构良好的 WORKGPT PR 应该聚焦且自包含。通常：
...
向 WORKGPT 贡献代码即表示你同意你的贡献将基于 [MIT 许可证](../LICENSE) 发布。
