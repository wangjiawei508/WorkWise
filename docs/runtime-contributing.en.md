# WorkWise Agent Runtime Contribution Guide: Architecture, design patterns and code organization ideas
...
> Supporting documents:[`runtime-architecture.md`](./runtime-architecture.md)
...
**WorkWise Agent Runtime is a strict implementation of Ports & Adapters + Functional Core / Imperative
...
WorkWise Agent Runtime's directory itself is a hexagonal physical layout:
...
WorkWise Agent Runtime uses multiple classic patterns simultaneously, which reinforce each other rather than conflict.
...
- `docs/runtime-architecture.md` describes "why it is designed this way";
- `kun/README.md` description CLI/env/data dir;
- `docs/runtime-contributing.md` (this article) describes "how to contribute";
...
- [ ] Do not modify any files other than those described in `docs/runtime-architecture.md`
      to "bypass" typecheck
...
- [ ] When adding a new SSE event, add a line to `docs/runtime-architecture.md`- [ ] in the borrow map of `docs/runtime-architecture.md` (as in the future
...
> **WorkWise Agent Runtime is a strict implementation of Ports & Adapters + Functional Core /
