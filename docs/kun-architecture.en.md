...
This document describes how WORKGPT should now be organized around one dedicated runtime,
...
Renderer (React + Zustand)
  Code / Write / Connect phone UI
        |
        | window.workgpt.runtimeRequest(path, method, body)
        | window.workgpt.startSse(threadId, sinceSeq)
        v
Preload IPC bridge
        |
        v
