...
try {
  ...
  async function makeDelivery(label, value) {
    ...
    assert(['application/vnd.openxmlformats-officedocument.wordprocessingml.document', 'application/pdf', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'].every(type => manifest.outputs.some(output => output.mediaType === type)), 'Full DOCX/PDF/XLSX outputs expected; retained trend images may be additional members')
