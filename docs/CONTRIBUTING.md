...
Thank you for contributing to WORKGPT.
...
For WORKGPT, taste means clear workflows, restrained interfaces, humane copy, and behavior that feels obvious after one use. Strong contributions show judgment, not just implementation.
...
A well-structured PR for WORKGPT is focused and self-contained. It typically:
...
- WORKGPT version (from Settings or the About dialog)
...
By contributing to WORKGPT, you agree that your contributions will be licensed under the [MIT License](../LICENSE).
