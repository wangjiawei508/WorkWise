...
- **Write 写作模式**：独立管理 `~/.workgpt/write_workspace` 和自定义写作空间，读取 Markdown 文件树，支持 live Markdown 编辑、相对图片预览、DeepSeek FIM 短补全 / 灵感长补全（可用跨文本 BM25 + 关键词检索增强）、当前文档导出为 `HTML / PDF / DOC / DOCX`，以及选中文本后直接唤起 inline 写作助手。
...
- 普通用户：可在设置页检查 GUI 更新，或前往 [GitHub Releases](https://github.com/wangjiawei508/WORKGPT/releases) 下载最新安装包。
