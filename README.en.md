<p align="center">
  <img src="src/asset/img/workgpt.png" width="96" alt="WORKGPT icon">
</p>
...
[Project](https://github.com/wangjiawei508/WORKGPT) | [Download](https://github.com/wangjiawei508/WORKGPT/releases)
...
<p align="center">
  <a href="src/asset/img/code.mp4">
    <img src="src/asset/img/code.gif" width="410" alt="WORKGPT Code mode demo">
  </a>
  <a href="src/asset/img/write.mp4">
    <img src="src/asset/img/write.gif" width="410" alt="WORKGPT Write mode demo">
  </a>
</p>
...
The only active local agent runtime in WORKGPT today is
...
WORKGPT is centered on two main workbenches, **Code** and **Write**,
...
<p align="center">
  <img src="src/asset/img/codemode.png" alt="WORKGPT Code mode" width="860">
</p>
...
<p align="center">
  <img src="src/asset/img/writemode.png" alt="WORKGPT Write mode" width="860">
</p>
...
<p align="center">
  <img src="src/asset/img/clawmode.png" alt="WORKGPT Connect phone" width="860">
</p>
...
Download the latest build from [GitHub Releases](https://github.com/wangjiawei508/WORKGPT/releases):
...
Write mode extends WORKGPT from a code/chat workbench into a long-form writing workspace. Its implementation borrows several ideas from the local `openhanako` reference project:
...
- Open Settings -> Apps -> Installed apps, find `WORKGPT`, and uninstall it.
...
- Move `WORKGPT.app` from Applications to Trash.
...
Kun data lives under `~/.workgpt/kun` or the configured Kun data dir. Check it before deleting, because it may contain sessions, MCP, or Skill settings you still need.
...
- Everyone who contributes issues, ideas, code, and documentation to WORKGPT.
