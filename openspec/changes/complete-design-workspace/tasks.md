...
- [x] 6.9 Rebuild and install the corrected 0.3.2 candidate, then verify conversational poster/PPT creation, isolated canvas pan/zoom, and real PNG/SVG/PPTX artifact delivery
