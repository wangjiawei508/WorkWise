...
- [x] 7.4 Build a fresh candidate package and launch the exact packaged GUI to re-test Write long-form input and attachment import, Scheduled tasks, Flow starter visibility, and Design PPT import/targeted AI modification before any replacement release.
