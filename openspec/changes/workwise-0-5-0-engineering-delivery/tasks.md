...
- [ ] Bind both advanced trials to immutable project-scoped input evidence, authenticated Runtime/IPC, strict replay, bounded history and bilingual manual UI; keep declared experimental models separate from validated production covariance.
