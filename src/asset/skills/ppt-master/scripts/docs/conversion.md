...
WorkWise slim converter: pure-Python for common document formats.
...
Unsupported legacy formats should be converted to DOCX, Markdown, PDF, HTML, XLSX, or PPTX first.
