...
import { DESKTOP_COMMANDS } from '../../shared/workgpt-api'
...
const modelProviderApiTypeSchema = z.enum(['chat_completions', 'responses'])
const kunRuntimeApiTypeSchema = z.enum(['inherit', 'chat_completions', 'responses'])
const modelProviderPatchSchema = z.object({
  ...
  providers: z.array(z.object({
    ...
    apiKey: z.string().max(MAX_BODY_BYTES).optional(),
    baseUrl: z.string().trim().max(MAX_URL_LENGTH).optional(),
    apiType: modelProviderApiTypeSchema.optional(),
...
const kunRuntimePatchSchema = z.object({
  ...
  apiType: kunRuntimeApiTypeSchema.optional(),
