...
export const DEFAULT_WRITE_WORKSPACE_ROOT = '~/.workgpt/write_workspace'
export const DEFAULT_KUN_DATA_DIR = '~/.workgpt/kun'
...
export type ModelProviderApiType = 'chat_completions' | 'responses'
export type KunRuntimeApiType = 'inherit' | ModelProviderApiType
...
export type KunRuntimeSettingsV1 = {
  ...
  providerId: string
  /** Assistant API protocol override. `inherit` follows the selected model provider. */
  apiType: KunRuntimeApiType
  runtimeToken: string
  dataDir: string
  model: string
