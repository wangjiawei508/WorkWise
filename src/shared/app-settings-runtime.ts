...
/**
 * WorkWise Runtime settings. Mirrors the bundled runtime CLI
...
// WorkWise-facing names. The persisted `agents.kun` key remains encapsulated here.
export const defaultManagedRuntimeSettings = defaultKunRuntimeSettings
export const defaultManagedRuntimeTokenEconomySettings = defaultKunTokenEconomySettings
export const defaultManagedRuntimeTuningSettings = defaultKunRuntimeTuningSettings
export const getManagedRuntimeSettings = getKunRuntimeSettings
export const mergeManagedRuntimeSettings = mergeKunRuntimeSettings
export const withManagedRuntimeSettings = withKunRuntimeSettings
export const applyManagedRuntimePatch = applyKunRuntimePatch
export const isManagedRuntimeInsecure = isKunRuntimeInsecure
...
export function migrateLegacyAppSettings(parsed: LegacyAppSettingsShape): Partial<AppSettingsV1> {
  ...
  // runtime now has a single agent (WorkWise Runtime) and we no longer
