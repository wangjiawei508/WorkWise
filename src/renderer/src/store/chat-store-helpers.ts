...
const COMPOSER_MODEL_STORAGE_KEY = 'workgpt.composerModel'
const TURN_MODEL_STORAGE_KEY = 'workgpt.turnModelLabel'
const CODE_WORKSPACE_ROOTS_STORAGE_KEY = 'workgpt.codeWorkspaceRoots.v1'
