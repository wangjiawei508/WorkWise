    ...
    const block = toolBlock({
      meta: {
        plan: {
          ...
          relative_path: '.workgpt/plan/x.md',
          operation: 'draft'
        }
      }
    })
  ...
  it('extracts plan metadata from a successful create_plan tool result', () => {
    const block = toolBlock({
      meta: {
        ...
        plan: {
          plan_id: '/tmp/ws:.workgpt/plan/login.md',
          workspace_root: '/tmp/ws',
          relative_path: '.workgpt/plan/login.md',
          absolute_path: '/tmp/ws/.workgpt/plan/login.md',
          operation: 'draft',
    ...
    expect(meta).toEqual({
      planId: '/tmp/ws:.workgpt/plan/login.md',
      workspaceRoot: '/tmp/ws',
      relativePath: '.workgpt/plan/login.md',
      absolutePath: '/tmp/ws/.workgpt/plan/login.md',
      operation: 'draft',
