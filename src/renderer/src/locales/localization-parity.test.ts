...
const MARKETPLACE_KEYS = [
  ...
  'pluginSkillTenderMasterTitle',
  'pluginSkillTenderMasterDesc',
  'pluginSkillTenderMasterDetail',
  'pluginSkillDocumentIllustratorTitle',
  'pluginSkillDocumentIllustratorDesc',
  'pluginSkillDocumentIllustratorDetail',
  'pluginSkillSocialCardTitle',
  'pluginSkillSocialCardDesc',
  'pluginSkillSocialCardDetail',
  'pluginSkillLogoGeneratorTitle',
  'pluginSkillLogoGeneratorDesc',
  'pluginSkillLogoGeneratorDetail',
  'pluginSkillGuizangDetail',
  'pluginCommercialLicenseRequired',
  'pluginRedistributionLicenseRequired',
  'pluginNoRedistributionLicense',
  'pluginDetailExternalProject',
  'pluginOpenSource',
  'pluginExternalOnly'
] as const
