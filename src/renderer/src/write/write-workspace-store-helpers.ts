...
export const WRITE_PREVIEW_MODE_KEY = 'workgpt.write.preview-mode'
export const WRITE_ASSISTANT_OPEN_KEY = 'workgpt.write.assistant-open'
export const WRITE_ASSISTANT_MODEL_KEY = 'workgpt.write.assistant-model'
...
export function activeFileStorageKey(workspaceRoot: string): string {
  return `workgpt.write.active-file:${normalizePath(workspaceRoot)}`
}
