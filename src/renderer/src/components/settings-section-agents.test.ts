...
const labels: Record<string, string> = {
  ...
  kunApiType: 'Kun API protocol',
  kunApiTypeDesc: 'Kun API protocol description',
  modelProviderApiType: 'Provider API protocol',
  modelProviderApiTypeInherit: 'Use provider setting',
  modelProviderApiTypeChatCompletions: 'Chat Completions',
  modelProviderApiTypeResponses: 'Responses',
