      ...
      <header className="shrink-0 border-b border-ds-border-muted bg-ds-card px-4 py-4 sm:px-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex min-w-0 items-start gap-3">
            ...
            <div className="min-w-0"><div className="flex flex-wrap items-center gap-2"><p className="text-[10px] font-semibold uppercase tracking-[0.12em] text-accent">WorkWise / Kun Runtime</p><span className="inline-flex items-center gap-1 rounded-full border border-accent/20 bg-accent/5 px-2 py-0.5 text-[10px] font-medium text-accent"><Sparkles className="h-3 w-3" />工程 Agent</span></div><h1 className="mt-1 text-[21px] font-semibold tracking-tight">工程 AI 指挥台</h1><p className="mt-1 max-w-3xl text-[12.5px] leading-5 text-ds-muted">把工程目标交给 AI，结果留在证据链里。AI 负责理解任务、拆解计划和解释结果；导入、平差、阈值、图表与成果由同一个 Runtime 的确定性工具完成。</p></div>
          </div>
