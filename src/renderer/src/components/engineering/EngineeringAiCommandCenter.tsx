  ...
  return (
    <div className="flex min-h-full min-w-0 flex-col bg-ds-main text-ds-ink">
      ...
      <div className="grid min-h-0 flex-1 gap-3 p-3 sm:p-4 xl:grid-cols-[216px_minmax(0,1fr)_284px]">
        ...
        <main className="flex min-h-0 min-w-0 flex-col overflow-hidden border border-ds-border-muted bg-ds-card">
        ...
        <aside className="min-h-0 space-y-3 overflow-y-auto" aria-label="工程 Copilot 证据检查器">
