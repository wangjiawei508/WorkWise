...
const LEFT_PANEL_WIDTH_KEY = 'workgpt.layout.leftSidebarWidth'
const LEFT_PANEL_COLLAPSED_KEY = 'workgpt.layout.leftSidebarCollapsed'
const RIGHT_PANEL_WIDTH_KEY = 'workgpt.layout.rightInspectorWidth'
const RIGHT_PANEL_MODE_KEY = 'workgpt.layout.rightPanelMode'
